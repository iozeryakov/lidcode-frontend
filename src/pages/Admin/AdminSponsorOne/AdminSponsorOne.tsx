...
import { getSponsor, updateSponsor } from "../../../http/sponsorAPI";

import { AdminLayout } from "../../../layouts/AdminLayout/AdminLayout";
import { ADMIN_SPONSOR_ROUTER } from "../../../utils/consts";
import "../Admin.css";
...
export const AdminSponsorOne: FC = () => {
  ...
  return (
    <AdminLayout loading={loading}>
      <h1 className="adminmain-title">Спонсор {name.value}</h1>
